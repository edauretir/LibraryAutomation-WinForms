            ...
            if (lblKitapSayi.Text != "")
            {
                if (lblKayitliKitapSayi.Text == "" && int.Parse(lblKitapSayi.Text) <= 3 || lblKayitliKitapSayi.Text != "" && int.Parse(lblKayitliKitapSayi.Text) + int.Parse(lblKitapSayi.Text) <= 3)
                {
                    if (txtTcAra.Text != "" && txtAd.Text != "" && txtSoyad.Text != "" && dateTimePicker3.Text != "" && txtTelefon.Text != "")
                    {
                        ...
                        {
                            baglanti.Open();
                            SqlCommand komut = new SqlCommand("insert into emanetkitaplar(tc,ad,soyad,dogtar,telefon,barkodno,kitapadi,yazari,yayinevi,sayfasayisi,kitapsayisi,teslimtarihi,iadetarihi) values(@tc,@ad,@soyad,@dogtar,@telefon,@barkodno,@kitapadi,@yazari,@yayinevi,@sayfasayisi,@kitapsayisi,@teslimtarihi,@iadetarihi)", baglanti);
